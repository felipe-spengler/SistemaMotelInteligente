...
public class DadosOcupados {
    ...
    private boolean isAutoAtendimento;
    ...
    public void setAutoAtendimento(boolean autoAtendimento) {
        this.isAutoAtendimento = autoAtendimento;
    }
    ...
    public DadosOcupados(java.sql.Timestamp entrada, int idLocacao, float valorPeriodo, float valorPernoite, int numeroPessoas, float valorAdicional, String tempo, boolean auto) {
        this.horaEntrada = entrada;
        this.idLoca = idLocacao;
        this.valorPeriodo = valorPeriodo;
        this.valorPernoite = valorPernoite;

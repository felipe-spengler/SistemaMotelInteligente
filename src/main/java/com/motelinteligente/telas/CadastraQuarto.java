...
public class CadastraQuarto extends javax.swing.JFrame {
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel5)
                                        .addComponent(num_quarto, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jLabel2)
                                        .addComponent(tipo_quarto, javax.swing.GroupLayout.PREFERRED_SIZE, 26,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(val_quarto, javax.swing.GroupLayout.PREFERRED_SIZE, 28,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel3)
                                        .addComponent(jLabel11)
                                        .addComponent(pessoaAdicional, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(7, 7, 7)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel4)
                                        .addComponent(pernoite, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(bt_voltar, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(bt_salvar, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(bt_atualizar,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE, 32,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(bt_apagar, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGap(30, 30, 30)
                                                .addComponent(jLabel6)
    ...
    private void bt_salvarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bt_salvarActionPerformed
        ...
        if (continuar) {
            ...
            if (new fquartos().verExiste(numero_quarto) == true) {
                ...
                logger.warn("Quarto #" + numero_quarto + " JÁ EXISTE. Estado atual: "
                        + new fquartos().getStatus(numero_quarto));
                ...
                if (new fquartos().getStatus(numero_quarto).equals("ocupado")) {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Quarto já cadastrado e OCUPADO. Não é possível modificar no momento!");
                    continuar = false;
                    ...
                    int escolha = JOptionPane.showConfirmDialog(null,
                            "Esse quarto já está cadastrado. Deseja sobreescrever??");
                ...
                if (excluir == true) { // UPDATE
                    ...
                    if (new fquartos().fazOUp(novo, hora_adicional, periodo)) {
                        ...
                        if (dadosOcupados.containsKey(numero_quarto)) {
                            ...
                            // O cacheOcupado não precisa de `put` aqui, pois `quartoOcupado` é uma
                            // referência.
                        } else {
                            logger.debug(
                                    "Quarto #" + numero_quarto + " não estava no CacheOcupado, apenas no CacheQuarto.");
                        }
                    ...
                    if (new fquartos().insercao(novo, hora_adicional, periodo) == true) {
                        ...
                        CarregaQuarto quarto = new CarregaQuarto(numero_quarto, tp_quarto, "livre",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastraQuarto.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        }
        // </editor-fold>

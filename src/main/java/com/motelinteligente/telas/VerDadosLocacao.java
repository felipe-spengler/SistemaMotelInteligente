 ...
 * @author MOTEL
 */
public class VerDadosLocacao extends javax.swing.JFrame {

    private int  idLocacao, numeroQuarto, idCaixa;
    private List<vendaProdutos> produtos;

    /**
     * Creates new form UltimaLocacao
     */
    public VerDadosLocacao( int idLocacao) {
        ...
        String consultaSQL = "SELECT * FROM registralocado WHERE idlocacao = ?";
        ...
        try {
            ...
            if (resultado.next()) {
                numeroQuarto = resultado.getInt("numquarto");

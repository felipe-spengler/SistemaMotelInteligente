...
public class Quadrado extends javax.swing.JPanel {
    ...
    public Quadrado(int numero, String tipo, String data, Color minhacor, boolean autoAtend) {
        initComponents();
        p2.setOpaque(false);
        p2.repaint();
    ...
    public void atualizar(String data, Color minhacor, boolean autoAtend) {
        if (data == null) {
            manut.setText("");
        } else {
            manut.setText(data);
    ...
    private void initComponents() {
        ...
        manut.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        
        lblAuto.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblAuto.setForeground(new java.awt.Color(255, 255, 255));
        lblAuto.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblAuto.setText("AUTOATENDIMENTO");
        lblAuto.setPreferredSize(new java.awt.Dimension(190, 20));
        ...
        p2Layout.setHorizontalGroup(
            ...
            .addGroup(p2Layout.createSequentialGroup()
                ...
                .addGroup(p2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblAuto, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)

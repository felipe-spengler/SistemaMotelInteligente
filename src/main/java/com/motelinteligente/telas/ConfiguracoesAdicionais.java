...
public class ConfiguracoesAdicionais extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        botaoRF = new javax.swing.JRadioButton();
        botaoBotoeira = new javax.swing.JRadioButton();
        botaoCodigos = new javax.swing.JToggleButton();
        ...
        jLabel7.setText("Abertura Portões:");

        botaoRF.setText("Portões RF");
        botaoRF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botaoRFActionPerformed(evt);
            }
        });

        botaoBotoeira.setText("Portões Botoeira");
        botaoBotoeira.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botaoBotoeiraActionPerformed(evt);
            }
        });

        botaoCodigos.setText("Códigos Portões");
        botaoCodigos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botaoCodigosActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(botaoBotoeira)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addComponent(botaoRF)
                                .addGap(31, 31, 31)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 53, Short.MAX_VALUE)
                        .addComponent(botaoCodigos)
                        .addGap(20, 20, 20))))
        );
    ...
    private void botaoRFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoRFActionPerformed
        // ação no botao RF
        botaoRF.setSelected(true);
        botaoBotoeira.setSelected(false);
        funcaoSet("portoesrf", true);
        botaoCodigos.setVisible(true);
    }//GEN-LAST:event_botaoRFActionPerformed

    private void botaoBotoeiraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoBotoeiraActionPerformed
        // ação no botao Botoeira
        botaoRF.setSelected(false);
        botaoBotoeira.setSelected(true);
        funcaoSet("portoesrf", false);
        botaoCodigos.setVisible(false);
    ...
    private javax.swing.JRadioButton botaoBotoeira;
    private javax.swing.JToggleButton botaoCodigos;

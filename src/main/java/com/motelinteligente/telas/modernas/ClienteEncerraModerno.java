...
public class ClienteEncerraModerno extends JFrame {
    ...
    private void initUI() {
        ...
        // Margem padronizada para 20 para ser responsivo
        infoPanel.setLayout(new MigLayout("fillx, wrap 1, insets 20", "[grow]", "[]15[]15[]push[]"));
        ...
        // Margem padronizada para 20
        JPanel footerProd = new JPanel(new MigLayout("fillx, insets 15 20 20 20", "push[]10[]"));

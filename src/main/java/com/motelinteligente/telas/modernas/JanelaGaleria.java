...
public class JanelaGaleria extends JDialog {
                ...
                if (json.getBoolean("success")) {
                    ...
                    if (array.length() == 0) {
                        SwingUtilities.invokeLater(() -> {
                            ...
                            pnlFotos.add(new JLabel("Nenhuma foto encontrada. Clique em 'Enviar Nova Foto'!",
    ...
    private void fazerNovoUpload() {
        ...
        fc.setFileFilter(
                new javax.swing.filechooser.FileNameExtensionFilter("Imagens", "jpg", "jpeg", "png", "webp", "jfif"));
